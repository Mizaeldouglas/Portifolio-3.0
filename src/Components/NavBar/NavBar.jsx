            ...
            <div className={styles.navbar}>
                ...
                <nav>
                    <ul className={styles.list}>
                        ...
                        <Link className={styles.link} href="/ContactForm" as="/contato" id='contato' >Contato</Link >
                        <Navlink url='https://drive.google.com/file/d/1iwkBpv9OtwiS7yb1sQoRhxOAmFtb-5lI/view' target='_blank' text='Curriculo' />
                    </ul>
                </nav>
